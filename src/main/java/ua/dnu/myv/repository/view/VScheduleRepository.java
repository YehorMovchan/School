...
public interface VScheduleRepository extends JpaRepository<ViewSchedule, Long> {
    ...
    public List<ViewSchedule> findHistory(LocalDate from, LocalDate to, Integer dayOfWeek);
